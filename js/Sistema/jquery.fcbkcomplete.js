...
(function( $, undefined ) {
  $.fn.fcbkcomplete = function(opt) {
    return this.queue( function() {
      ...
      function createFCBK() {
        holder = $('<ul class="holder" style="width:'+(options.ancho-3)+'px;"></ul>');
        if (options.attachto) {
        ...
        complete = $('<div class="facebook-auto" style="width:' + options.ancho + 'px;">').append('<div class="default" style="width:' + options.ancho + 'px;">' + options.complete_text + "</div>");
